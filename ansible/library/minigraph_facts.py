...
def parse_xml(filename, hostname):
    ...
    if hwsku == "Force10-S6000":
        ...
        for i in range(0, 96, 4):
            port_alias_map["slot{}-{}".format(i/2+1, (i/2 + 2))] = "Ethernet{}".format(i)
        # from port 96 - 124 are 100G
        for i in range(96, 128, 4):
            port_alias_map["Eth{}".format(i/4-23)] = "Ethernet{}".format(i)
    elif hwsku == "Open19-Bolt-50-100":
        # from port 0 - 94 are 50G
        for i in range(0, 96, 2):
            port_alias_map["slot{}".format(i/2 + 1)] = "Ethernet{}".format(i)
        # from port 96 - 124 are 100G
        for i in range(96, 128, 4):
            port_alias_map["Eth{}".format(i/4 - 23)] = "Ethernet{}".format(i)
        ...
        for i in range(0, 96):
            port_alias_map["slot{}/{}".format((i/2 + 1), (i%2 + 1))] = "Ethernet{}".format(i)
        # from port 96 - 124 are 100G
        for i in range(96, 128, 4):
            port_alias_map["Eth{}".format(i/4 - 23)] = "Ethernet{}".format(i)
        ...
        # from port 96 - 126 are 50G
        for i in range(96, 128, 2):
            port_alias_map["Eth{}/{}".format(i/4 - 23, (i%4)/2 + 1)] = "Ethernet{}".format(i)
